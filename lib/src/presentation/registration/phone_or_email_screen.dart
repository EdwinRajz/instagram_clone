...
class PhoneOrEmailScreen extends StatefulWidget {
  const PhoneOrEmailScreen({Key key, @required this.onNext, @required this.onChanged}) : super(key: key);

  final VoidCallback onNext;
  final ValueChanged<RegisterType> onChanged;

  @override
  _PhoneOrEmailScreenState createState() => _PhoneOrEmailScreenState();
}

class _PhoneOrEmailScreenState extends State<PhoneOrEmailScreen> with SingleTickerProviderStateMixin {
